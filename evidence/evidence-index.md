# AWS Task 2 Evidence Index

This document maps the Task 2 requirements to the corresponding project evidence.
...
| Security Groups | `screenshots/security-groups/security-group.jpeg` |
...
| Static Site | `screenshots/s3/s3-site.jpeg` |
